...
namespace YouTunelPutty20.NotifyIconWpf.Interop
{
    /// <summary>
    ...
    public struct NotifyIconData
    {
        ...
        /// For example, setting this member to <see cref="NotifyIconWpf.Interop.IconState.Hidden"/>
        ...
        /// of the tray icon. If this member is non-NULL and the <see cref="NotifyIconWpf.Interop.BalloonFlags.User"/>
